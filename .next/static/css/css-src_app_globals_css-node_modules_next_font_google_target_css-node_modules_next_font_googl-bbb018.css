...
/*!*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** css ./node_modules/next/dist/build/webpack/loaders/css-loader/src/index.js??ruleSet[1].rules[13].oneOf[2].use[1]!./node_modules/next/dist/build/webpack/loaders/next-font-loader/index.js??ruleSet[1].rules[13].oneOf[2].use[2]!./node_modules/next/font/google/target.css?{"path":"src\\app\\layout.tsx","import":"Roboto_Mono","arguments":[{"subsets":["latin"],"variable":"--font-roboto-mono"}],"variableName":"robotoMono"} ***!
  \*****************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************************/
/* cyrillic-ext */
@font-face {
...
samp,
pre {
  font-family: var(--font-roboto-mono); /* 1 */
...
.border-primary-100 {
  --tw-border-opacity: 1;
  border-color: rgb(225 248 232 / var(--tw-border-opacity, 1));
}
.border-primary-200 {
  --tw-border-opacity: 1;
  border-color: rgb(195 239 210 / var(--tw-border-opacity, 1));
}
.border-primary-500 {
  --tw-border-opacity: 1;
...
.border-primary-500\/30 {
  border-color: rgb(46 204 113 / 0.3);
}
.border-primary-600 {
  --tw-border-opacity: 1;
  border-color: rgb(15 81 50 / var(--tw-border-opacity, 1));
}
.border-primary-700\/50 {
  border-color: rgb(11 70 42 / 0.5);
}
.border-purple-100 {
  --tw-border-opacity: 1;
...
.bg-primary-100 {
  --tw-bg-opacity: 1;
  background-color: rgb(225 248 232 / var(--tw-bg-opacity, 1));
}
.bg-primary-200 {
  --tw-bg-opacity: 1;
  background-color: rgb(195 239 210 / var(--tw-bg-opacity, 1));
}
.bg-primary-400 {
  --tw-bg-opacity: 1;
  background-color: rgb(90 204 146 / var(--tw-bg-opacity, 1));
}
.bg-primary-400\/10 {
  background-color: rgb(90 204 146 / 0.1);
}
.bg-primary-50 {
  --tw-bg-opacity: 1;
  background-color: rgb(242 252 245 / var(--tw-bg-opacity, 1));
}
.bg-primary-500 {
  --tw-bg-opacity: 1;
...
.bg-primary-600 {
  --tw-bg-opacity: 1;
  background-color: rgb(15 81 50 / var(--tw-bg-opacity, 1));
}
.bg-primary-600\/20 {
  background-color: rgb(15 81 50 / 0.2);
}
.bg-primary-700\/50 {
  background-color: rgb(11 70 42 / 0.5);
}
.bg-primary-800\/50 {
  background-color: rgb(8 57 34 / 0.5);
}
.bg-primary-900 {
  --tw-bg-opacity: 1;
  background-color: rgb(6 45 27 / var(--tw-bg-opacity, 1));
}
.bg-purple-100 {
  --tw-bg-opacity: 1;
...
.bg-\[url\(\'https\:\/\/images\.unsplash\.com\/photo-1522770179533-24471fcdba45\?q\=80\&w\=2000\&auto\=format\&fit\=crop\'\)\] {
  background-image: url('https://images.unsplash.com/photo-1522770179533-24471fcdba45?q=80&w=2000&auto=format&fit=crop');
}
...
.bg-\[url\(\'https\:\/\/images\.unsplash\.com\/photo-1556906781-9a412961c28c\?auto\=format\&fit\=crop\&q\=80\'\)\] {
  background-image: url('https://images.unsplash.com/photo-1556906781-9a412961c28c?auto=format&fit=crop&q=80');
}
.bg-\[url\(\'https\:\/\/images\.unsplash\.com\/photo-1574629810360-7efbbe195018\?q\=80\&w\=2093\&auto\=format\&fit\=crop\'\)\] {
...
.from-primary-400 {
  --tw-gradient-from: #5acc92 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(90 204 146 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-primary-500 {
...
.from-primary-500\/10 {
  --tw-gradient-from: rgb(46 204 113 / 0.1) var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(46 204 113 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-primary-600 {
  --tw-gradient-from: #0F5132 var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(15 81 50 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.from-primary-900 {
  --tw-gradient-from: #062d1b var(--tw-gradient-from-position);
  --tw-gradient-to: rgb(6 45 27 / 0) var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), var(--tw-gradient-to);
}
.via-gray-900\/80 {
  --tw-gradient-to: rgb(17 24 39 / 0)  var(--tw-gradient-to-position);
...
.via-primary-800 {
  --tw-gradient-to: rgb(8 57 34 / 0)  var(--tw-gradient-to-position);
  --tw-gradient-stops: var(--tw-gradient-from), #083922 var(--tw-gradient-via-position), var(--tw-gradient-to);
}
.via-transparent {
  --tw-gradient-to: rgb(0 0 0 / 0)  var(--tw-gradient-to-position);
...
.to-primary-400 {
  --tw-gradient-to: #5acc92 var(--tw-gradient-to-position);
}
.to-primary-700 {
  --tw-gradient-to: #0b462a var(--tw-gradient-to-position);
}
.to-secondary-400 {
  --tw-gradient-to: #4ade80 var(--tw-gradient-to-position);
}
.to-secondary-500 {
  --tw-gradient-to: #2ECC71 var(--tw-gradient-to-position);
}
.to-transparent {
...
.text-primary-100 {
  --tw-text-opacity: 1;
  color: rgb(225 248 232 / var(--tw-text-opacity, 1));
}
.text-primary-200 {
  --tw-text-opacity: 1;
  color: rgb(195 239 210 / var(--tw-text-opacity, 1));
}
.text-primary-300 {
  --tw-text-opacity: 1;
  color: rgb(148 226 181 / var(--tw-text-opacity, 1));
}
.text-primary-400 {
  --tw-text-opacity: 1;
  color: rgb(90 204 146 / var(--tw-text-opacity, 1));
}
.text-primary-50 {
  --tw-text-opacity: 1;
  color: rgb(242 252 245 / var(--tw-text-opacity, 1));
}
.text-primary-500 {
  --tw-text-opacity: 1;
...
.text-primary-700 {
  --tw-text-opacity: 1;
  color: rgb(11 70 42 / var(--tw-text-opacity, 1));
}
.text-primary-800 {
  --tw-text-opacity: 1;
  color: rgb(8 57 34 / var(--tw-text-opacity, 1));
}
.text-primary-900 {
  --tw-text-opacity: 1;
  color: rgb(6 45 27 / var(--tw-text-opacity, 1));
}
.text-purple-600 {
  --tw-text-opacity: 1;
...
.shadow-primary-500\/50 {
  --tw-shadow-color: rgb(46 204 113 / 0.5);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-primary-600\/20 {
  --tw-shadow-color: rgb(15 81 50 / 0.2);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-primary-600\/30 {
  --tw-shadow-color: rgb(15 81 50 / 0.3);
  --tw-shadow: var(--tw-shadow-colored);
}
...
.shadow-secondary-500\/20 {
  --tw-shadow-color: rgb(46 204 113 / 0.2);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-secondary-500\/30 {
  --tw-shadow-color: rgb(46 204 113 / 0.3);
  --tw-shadow: var(--tw-shadow-colored);
}
.shadow-yellow-100 {
...
.ring-primary-500 {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(46 204 113 / var(--tw-ring-opacity, 1));
}
.ring-primary-600 {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(15 81 50 / var(--tw-ring-opacity, 1));
}
.ring-secondary {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(46 204 113 / var(--tw-ring-opacity, 1));
...
.hover\:border-primary-300:hover {
  --tw-border-opacity: 1;
  border-color: rgb(148 226 181 / var(--tw-border-opacity, 1));
}
...
.hover\:bg-primary-50\/60:hover {
  background-color: rgb(242 252 245 / 0.6);
}
...
.hover\:bg-primary-700:hover {
  --tw-bg-opacity: 1;
  background-color: rgb(11 70 42 / var(--tw-bg-opacity, 1));
}
...
.focus\:ring-\[\#25D366\]\/20:focus {
  --tw-ring-color: rgb(37 211 102 / 0.2);
}

.focus\:ring-primary-200:focus {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(195 239 210 / var(--tw-ring-opacity, 1));
}
...
.focus\:ring-primary-500\/20:focus {
  --tw-ring-color: rgb(46 204 113 / 0.2);
}
...
.peer:focus ~ .peer-focus\:ring-primary-300 {
  --tw-ring-opacity: 1;
  --tw-ring-color: rgb(148 226 181 / var(--tw-ring-opacity, 1));
}
